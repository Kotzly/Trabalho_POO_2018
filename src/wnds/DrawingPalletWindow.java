...
public class DrawingPalletWindow extends JFrame {
	...
	/**
	 * Launch the application (for debugging only)
	 */
	...
	/**
	 * Constructs the window, initializing all of its components
	 */
	...
	/**
	 * Check if fill shape radio button is selected
	 */
